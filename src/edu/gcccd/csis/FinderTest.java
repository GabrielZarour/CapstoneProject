...
public class FinderTest {
    ...
    public void testExtreme() throws Exception {
        ...
        assertEquals(f2, edu.gcccd.csis.Finder.extreme(f1, f2));
        assertEquals(f2, edu.gcccd.csis.Finder.extreme(f2, f1));
        ...
        assertEquals(f4, edu.gcccd.csis.Finder.extreme(f3, f4));
        assertEquals(f3, edu.gcccd.csis.Finder.extreme(f4, f3));
        ...
        f5.deleteOnExit();
        f6.deleteOnExit();
        assertEquals(edu.gcccd.csis.Finder.findExtremeFile(Paths.get(".")), findExtremeFile(Paths.get(".")));
    }
    /**
